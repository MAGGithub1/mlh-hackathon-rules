...
These rules are adapted from the [standard competition rules](https://github.com/MLH/hackathon-rules) for MLH Member Hackathons.
...
6. All projects must either;
  i. Be a game (platformer, RPG, etc.)
  ii. Contain a game-like element (e.g. a website where one section is a game)
